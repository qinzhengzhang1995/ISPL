...
#####train ######
list_title_train = os.listdir('..//yuan_gaizheng//train100_4000')
url_train = '..//yuan_gaizheng//train100_4000//'
type1 = 'x_train'
...
###############test#################
list_title_test = os.listdir('..//yuan_gaizheng//test100_1000')
url_test = '..//yuan_gaizheng//test100_1000//'
...
print(model_new)
model_new.to(device)
opt = torch.optim.Adam(model_new.parameters(), lr=4e-4, weight_decay=1e-6)    ###  DML为1E-4   ，   CustomAlexNet 为2e-5
